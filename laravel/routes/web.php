...
Route::prefix('platform')->group(function () {
    ...
    Route::get('/getsentryFront', [PlatformController::class, 'getsentryFront']);
    Route::get('/getsentryBack', [PlatformController::class, 'getsentryBack']);
    Route::get('/getAllCompanies', [PlatformController::class, 'getAllCompanies']);
    Route::get('/getAllWorkers', [PlatformController::class, 'getAllWorkers']);
...
Route::prefix('worker')->group(function () {
    ...
    Route::post('/getPostsMatcheVoice', [WorkerController::class, 'getPostsMatcheVoice']);
    ...
    Route::post('/cv/generate', [WorkerController::class, 'generateCV']);
    Route::get('/public-profile/{workerId}', [WorkerController::class, 'getWorkerPublicProfile']);
 ...
 Route::prefix('company')->group(function () {
    ...
    Route::post('/sendmail', [CompanyController::class, 'sendmail']);
