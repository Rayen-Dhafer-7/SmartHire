  ...
  <div class="inprogress-wrapper">
    ...
    <div class="inprogress-container">
      <div class="page-header">
        <div class="header-content">
          <div>
            ...
            <p class="page-subtitle">Manage your active job postings</p>
          </div>
          <div class="actions-group">
            <router-link to="/company/add-post" class="btn-create">
      ...
      <div v-else-if="filteredPosts.length === 0" class="empty-state">
        ...
        <h4 v-else>No active job posts found</h4>
        <p>Create your first job post to get started</p>
        <router-link to="/company/add-post" class="btn-create-empty">
          Create New Post
        </router-link>
      </div>
...
/* Animated Background (same as above) */
.animated-bg {
  position: fixed;
  top: 0;
  left: 0;
